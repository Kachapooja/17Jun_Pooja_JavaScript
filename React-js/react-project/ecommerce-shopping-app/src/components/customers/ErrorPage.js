...
export default function ErrorPage() {
  return (
<div>
<MDBContainer fluid className='error-page'>
    ...
    <div className='text-center mt-5'>
        <img src={error} alt=''/>
        <div>
            <h3 style={{color:"#000000"}}>Oops! Page not found</h3>
            <span style={{fontSize:"15px",color:"#807d7e"}}>The Page you are looking for might have been removed or</span><br/>
            <span style={{fontSize:"15px",color:"#807d7e"}}> temporary unavailable.</span><br/>
            <Link to='/'><button className='border border-0 rounded-3 text-white px-4 py-2 mt-3' style={{fontSize:"15px",backgroundColor:"#8a33fd"}}>Back to HomePage</button></Link>
        </div>
    </div>
